...
namespace GamerscoinWrapper.Wrapper
{
    ...
    public sealed class BaseGamerscoinConnector : IBaseGamerscoinConnector
    {
        ...
        public String GetAccount(String GamerscoinAddress)
        {
            return _baseConnector.RequestServer(MethodName.getaccount, GamerscoinAddress)["result"].ToString();
        }
        ...
        public String DumpPrivKey(String GamerscoinAddress)
        {
            return _baseConnector.RequestServer(MethodName.dumpprivkey, GamerscoinAddress)["result"].ToString();
        }
        ...
        public String GetReceivedByAddress(String GamerscoinAddress)
        {
            return _baseConnector.RequestServer(MethodName.getreceivedbyaddress, GamerscoinAddress)["result"].ToString();
        }
        ...
        public String ValidateAddress(String GamerscoinAddress)
        {
            return _baseConnector.RequestServer(MethodName.validateaddress, GamerscoinAddress)["result"].ToString();
        }
        ...
        /// <returns></returns>
        public String SendToAddress(String GamerscoinAddress, Decimal amount)
        {
            return _baseConnector.RequestServer(MethodName.sendtoaddress, new List<object> { GamerscoinAddress, amount })["result"].ToString();
        }
        ...
        public String SendFrom(String fromAccount, String toGamerscoinAddress, Decimal amount)
        {
            return _baseConnector.RequestServer(MethodName.sendfrom, new List<object> { fromAccount, toGamerscoinAddress, amount })["result"].ToString();
        }

        public String SignMessage(String GamerscoinAddress, String message)
        {
            return _baseConnector.RequestServer(MethodName.signmessage, new List<object> { GamerscoinAddress, message })["result"].ToString();
        }
        ...
        public String VerifyMessage(String GamerscoinAddress, String signature, String message)
        {
            return _baseConnector.RequestServer(MethodName.verifymessage, new List<object> { GamerscoinAddress, signature, message })["result"].ToString();
        }
